...
--
-- Host: localhost
-- Generation Time: Apr 19, 2018 at 12:36 AM
...
('N12b', 'Kayak', 'North Dock', 'K', 'Normal', 14, 0, '2016-12-08 08:33:13'),
('N12a', 'Kayak', 'North Dock', 'K', 'Normal', 14, 0, '2016-12-08 08:33:13'),
...
('N10b', 'Kayak', 'North Dock', 'K', 'Normal', 14, 0, '2016-12-08 08:33:13'),
...
('S04a', 'Kayak', 'South Dock', 'K', 'Normal', 14, 0, '2016-12-08 08:33:13'),
('S04b', 'Kayak', 'South Dock', 'K', 'Normal', 14, 0, '2016-12-08 08:33:13'),
...
('S20', 'Slip', 'South Dock', 'A', 'Lift', 14, 0, '2016-12-08 08:33:13'),
('S21', 'Slip', 'South Dock', 'B', 'Lift', 14, 0, '2016-12-08 08:33:13'),
...
('N10a', 'Kayak', 'North Dock', 'K', 'Normal', 14, 0, '2016-12-08 08:33:13'),
...
INSERT INTO `UnitMaster` (`unit`, `space`, `model`, `sqft`, `decks`, `vote`, `beds`, `baths`, `propid`, `bldg`, `floor`, `stack`) VALUES
...
--
ALTER TABLE `Slips`
  MODIFY `slid` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=77;
--
-- AUTO_INCREMENT for table `UserUnit`
--
ALTER TABLE `UserUnit`
  MODIFY `userunitid` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=654;
--
-- AUTO_INCREMENT for table `WaitList`
--
ALTER TABLE `WaitList`
  MODIFY `wlid` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
