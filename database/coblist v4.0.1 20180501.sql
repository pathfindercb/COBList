...
--
-- Host: localhost
-- Generation Time: May 02, 2018 at 09:31 AM
...
CREATE TABLE IF NOT EXISTS `UserUnit` (
  ...
  `userid` varchar(15) DEFAULT NULL
) ENGINE=MyISAM AUTO_INCREMENT=19625 DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `Slips`
  MODIFY `slid` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2140;
--
-- AUTO_INCREMENT for table `UserUnit`
--
ALTER TABLE `UserUnit`
  MODIFY `userunitid` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=19625;
--
-- AUTO_INCREMENT for table `WaitList`
--
ALTER TABLE `WaitList`
  MODIFY `wlid` mediumint(9) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=239;
